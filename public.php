...
<html>
  <head>
    <meta charset="UTF-8">
    <title>WeatherMP - Mapping Weather Forecasting</title>
    ...
    function load() {
      ...
      downloadUrl("backend/map_marker_sumbagut.php", function(data) {
        ...
        for (var i = 0; i < markers.length; i++) {
		  ...
		  var tanggal = markers[i].getAttribute("tanggalMulai");
    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
				<?php
					include('pages/Widget/sidemenu_non_login.php');
				?>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Weather MP
            <small>Weather Online Forecasting</small>
          </h1>
        </section>
